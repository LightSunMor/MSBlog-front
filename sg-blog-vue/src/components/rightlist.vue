...
export default {
  data() {
    ...
    return {
      ...
      catchMeObj: {
        //个人信息
        git: "https://github.com/LightSunMor",
        qq: "/static/img/qqmySelf.png",
        wechat: "/static/img/qqmySelf.png",
        csdn: "https://blog.csdn.net/weixin_52445706?spm=1000.2115.3001.5343",
        job: "https://www.baidu.com", // 没用上
      },
    };
  },
  methods: {
